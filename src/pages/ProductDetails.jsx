...
import { ShoppingBag, ArrowLeft, Check, Minus, Plus, Heart, Share2 } from 'lucide-react';
          ...
          <div>
            ...
            <div className="mt-6 space-y-6">
                  ...
                  <div className="flex gap-3">
                    {product.sizes.map(size => (
                      <button
                        ...
                        className={`w-12 h-12 rounded-xl text-sm border-2 transition-all flex items-center justify-center ${
                          selectedSize === size
              ...
              {product.stock <= 5 && product.stock > 0 && (
                <p className="text-amber-600 text-sm font-medium">⚠ Plus que {product.stock} en stock</p>
              )}
              {product.stock === 0 && (
                <p className="text-red-600 text-sm font-medium">Rupture de stock</p>
              )}
            </div>
